...
export const CarFiltersProvider = ({ children }) => {
  const [data, setData] = useState({seatCount: 2,priceRange:[10, 500],automaticSelected:false, manualSelected:false, selectedBrands:[],selectedLocations:[], search:"",filter:false});
